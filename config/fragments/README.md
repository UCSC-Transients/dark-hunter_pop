...
# Phase 3 Review/Integration (issue #50): merge rv_consistency / triples into config.yaml.
# Phase 4 Review/Integration (issue #58): merge companion_nature (+ population_model) fragments.
# Fragments remain the draft source; loader still merges them first.
#
